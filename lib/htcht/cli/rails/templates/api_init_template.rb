...
insert_into_file('app/controllers/application_controller.rb',
                 "\s\sinclude Knock::Authenticable\n",
...
copy_file('build_files/user_spec.rb',
          'spec/models/user_spec.rb')
copy_file('build_files/users.rb',
          'spec/factories/users.rb')
copy_file('build_files/email_validator.rb',
          'app/validators/email_validator.rb')
copy_file('build_files/factory_girl.rb',
          'spec/support/factory_girl.rb')
copy_file('build_files/rails_helper.rb',
          'spec/rails_helper.rb')
copy_file('build_files/shoulda_matchers.rb',
          'spec/support/shoulda_matchers.rb')
copy_file('build_files/seeds.rb',
          'db/seeds.rb')
copy_file('build_files/active_model_serializers.rb',
          'config/initializers/active_model_serializers.rb')
copy_file('build_files/.rubocop.yml',
          '.rubocop.yml')
