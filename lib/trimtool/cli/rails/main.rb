    ...
    module Rails
      ...
      class Main < Thor
        ...
        def new(appname)
          ...
          # Use the bootstrap application template
          if options[:bootstrap] && options[:api]
            copy_file 'bootstrap_template.rb', "#{snake_name}/bootstrap_template.rb"
            rails_new_command.concat(' -m bootstrap_template.rb')
